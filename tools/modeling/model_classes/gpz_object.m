...
%             function     model = init(X,Y,method,m,'normalize',normalize,'heteroscedastic',heteroscedastic,'training',training,'Psi',Psi);
%                 x_data = X
%                 y_data = Y
%                 method = 'VL'
%                 
...
%             obj.inf_method              = 'VL';
            obj.x_data                  = x_data;
            obj.y_data                  = y_data;
            obj.gpz_model               = init(x_data,y_data,method,m,'normalize',normalize,'heteroscedastic',heteroscedastic,'training',training,'Psi',Psi);
