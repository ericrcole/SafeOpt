function [x_sample, x_opt_est, y_opt_est, safe_set, safe_ucb, objective_model] = safe_opt_update_memory(X_v, Y_ds, beta, eta, alpha, safe_set, threshold, input_space, USE_HYPERPRIOR, USE_SAFE, PLOT)
